/* ==========================================================================
   LASERPRINT ARCADE - DTF TEXTIL / UV ENGINE & AUDIO SYNTHESIZER (PRODUCTION)
   ========================================================================== */
...
document.addEventListener('DOMContentLoaded', () => {
  const categoria = document.body.getAttribute('data-categoria') || 'DTF TEXTIL / UV';
...
function createCardImagen(prod) {
  ...
  card.innerHTML = `
    ...
    <div class="card-info">
      ...
      <div class="card-price">${prod.precio ? '$' + prod.precio + ' MXN / metro' : 'COTIZAR'}</div>
    </div>
  `;
  return card;
}
...
function getDatosMOCK() {
  return [
    { nombre: 'IMPRESIÓN DTF TEXTIL POR METRO LINEAL', archivoUrl: '/uploads/fotos/dtf_textil_metro.png', tipoArchivo: 'imagen', precio: 250 },
    { nombre: 'STICKER DTF UV CON ACABADO BRILLANTE', archivoUrl: '/uploads/fotos/dtf_uv_stickers.png', tipoArchivo: 'imagen', precio: 280 },
    { nombre: 'DEMOSTRACIÓN DE PLANCHADO Y RETIRADO DTF', archivoUrl: '/uploads/videos/planchado_dtf_demo.mp4', tipoArchivo: 'video', precio: null },
    { nombre: 'PLANTILLA Y GUÍA DE PREPARACIÓN DE ARCHIVOS DTF', archivoUrl: '/uploads/docs/guia_preparacion_dtf.pdf', tipoArchivo: 'pdf', precio: null }
  ];
}
