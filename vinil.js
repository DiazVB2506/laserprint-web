/* ==========================================================================
   LASERPRINT ARCADE - VINIL ENGINE & AUDIO SYNTHESIZER (PRODUCTION)
   ========================================================================== */
...
document.addEventListener('DOMContentLoaded', () => {
  const categoria = document.body.getAttribute('data-categoria') || 'VINIL';
...
function getDatosMOCK() {
  return [
    { nombre: 'VINIL CORTE DE ALTA ADHERENCIA PARA CANCELERÍA', archivoUrl: '/uploads/fotos/vinil_corte.png', tipoArchivo: 'imagen', precio: 220 },
    { nombre: 'VINIL MICROPERFORADO PARA CRISTALES Y VEHÍCULOS', archivoUrl: '/uploads/fotos/vinil_microperforado.png', tipoArchivo: 'imagen', precio: 310 },
    { nombre: 'PROCESO DE DEPILADO Y APLICACIÓN DE VINIL', archivoUrl: '/uploads/videos/depilado_vinil.mp4', tipoArchivo: 'video', precio: null },
    { nombre: 'CATÁLOGO DE COLORES Y ACABADOS VINIL DE CORTE', archivoUrl: '/uploads/docs/catalogo_colores_vinil.pdf', tipoArchivo: 'pdf', precio: null }
  ];
}
