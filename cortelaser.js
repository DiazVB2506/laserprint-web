/* ==========================================================================
   LASERPRINT ARCADE - CORTE LÁSER ENGINE & AUDIO SYNTHESIZER (PRODUCTION)
   ========================================================================== */
...
document.addEventListener('DOMContentLoaded', () => {
  const categoria = document.body.getAttribute('data-categoria') || 'CORTE LASER';
...
/**
 * Convierte rutas relativas en URLs absolutas hacia el backend de Render
 */
...
function getDatosMOCK() {
  return [
    { nombre: 'LETRERO 3D EN ACRÍLICO Y MDF GRABADO', archivoUrl: '/uploads/fotos/corte_acrilico.png', tipoArchivo: 'imagen', precio: 650 },
    { nombre: 'CAJA DE CORTE VECTORIAL CALADO EN MDF 3MM', archivoUrl: '/uploads/fotos/caja_mdf.png', tipoArchivo: 'imagen', precio: 220 },
    { nombre: 'DEMOSTRACIÓN DE CORTE LÁSER CO2 EN TIEMPO REAL', archivoUrl: '/uploads/videos/laser_co2_demo.mp4', tipoArchivo: 'video', precio: null },
    { nombre: 'CATÁLOGOS DE MATERIALES Y GROSORES LÁSER', archivoUrl: '/uploads/docs/materiales_laser.pdf', tipoArchivo: 'pdf', precio: null }
  ];
}
